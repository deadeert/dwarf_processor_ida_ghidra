...
def main() : 
	...
	while(insn.getAddress()!=stop_ea):
		...
		elif (mnemonic.strip() in  ['REG0''REG0', 'REG1', 'REG2', 'REG3', 'REG4', 'REG5', 'REG6', 'REG7', 'REG8', 'REG9', 'REG10', 'REG11', 'REG12', 'REG13', 'REG14', 'REG15', 'REG16', 'REG17', 'REG18', 'REG19', 'REG20', 'REG21', 'REG22', 'REG23', 'REG24', 'REG25', 'REG26', 'REG27', 'REG28', 'REG29', 'REG30', 'REG31']):
			print('REGN') 
			stk.regn(31)
		elif (mnemonic.strip() == ['BREG0', 'BREG1', 'BREG2', 'BREG3', 'BREG4', 'BREG5', 'BREG6', 'BREG7', 'BREG8', 'BREG9', 'BREG10', 'BREG11', 'BREG12', 'BREG13', 'BREG14', 'BREG15', 'BREG16', 'BREG17', 'BREG18', 'BREG19', 'BREG20', 'BREG21', 'BREG22', 'BREG23', 'BREG24', 'BREG25', 'BREG26', 'BREG27', 'BREG28', 'BREG29', 'BREG30', 'BREG31', 'BREGX','REGX','FBREG'] ):
